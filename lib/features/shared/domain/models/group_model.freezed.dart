...
mixin _$GroupModel {
 ...
 String get id; String get name; List<String> get members;// List of user UIDs
 String get createdBy; int get createdAt;// Timestamp
 double get totalExpense; String? get iconUrl;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,const DeepCollectionEquality().hash(members),createdBy,createdAt,totalExpense,iconUrl);

@override
String toString() {
  return 'GroupModel(id: $id, name: $name, members: $members, createdBy: $createdBy, createdAt: $createdAt, totalExpense: $totalExpense, iconUrl: $iconUrl)';
}
...
@useResult
$Res call({
 String id, String name, List<String> members, String createdBy, int createdAt, double totalExpense, String? iconUrl
});
...
/// Create a copy of GroupModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? members = null,Object? createdBy = null,Object? createdAt = null,Object? totalExpense = null,Object? iconUrl = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  List<String> members,  String createdBy,  int createdAt,  double totalExpense,  String? iconUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GroupModel() when $default != null:
return $default(_that.id,_that.name,_that.members,_that.createdBy,_that.createdAt,_that.totalExpense,_that.iconUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  List<String> members,  String createdBy,  int createdAt,  double totalExpense,  String? iconUrl)  $default,) {final _that = this;
switch (_that) {
case _GroupModel():
return $default(_that.id,_that.name,_that.members,_that.createdBy,_that.createdAt,_that.totalExpense,_that.iconUrl);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  List<String> members,  String createdBy,  int createdAt,  double totalExpense,  String? iconUrl)?  $default,) {final _that = this;
switch (_that) {
case _GroupModel() when $default != null:
return $default(_that.id,_that.name,_that.members,_that.createdBy,_that.createdAt,_that.totalExpense,_that.iconUrl);case _:
  return null;
...
class _GroupModel implements GroupModel {
  const _GroupModel({required this.id, required this.name, required final  List<String> members, required this.createdBy, required this.createdAt, this.totalExpense = 0.0, this.iconUrl}): _members = members;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,const DeepCollectionEquality().hash(_members),createdBy,createdAt,totalExpense,iconUrl);
...
/// Create a copy of GroupModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? members = null,Object? createdBy = null,Object? createdAt = null,Object? totalExpense = null,Object? iconUrl = freezed,}) {
